		...
		<div class="row">
			<?php if(is_array($course)): foreach($course as $key=>$v1): ?><div class="course-block">
					...
					<div class="thumbnail col-lg-2 col-md-2 col-sm-2 col-xs-2 block1 full ellipsis">
						<a href="<?php echo U('Examiner/Notice/index',array('cno' =>$v1['cno']));?>"><?php echo ($v1["cname"]); ?></a>
					</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
								<label>更新日期：2017年10月11日</label>
							</div>
							<div class="form-group">
								1.新增系统更新提示框，您在初次使用新版系统时将可以浏览更新后的新特性。
							</div>
							<div class="form-group">
								2.教师/助教发布作业后，该课程所有助教默认具有批改权限，您无需每次都分配权限。
							</div>
							<div class="form-group">
								3.修复了文件名带有特殊符号时的作业下载乱码Bug。
							</div>
							<div class="form-group">
								4.修改了学生端分项分数显示Bug。
							</div>
