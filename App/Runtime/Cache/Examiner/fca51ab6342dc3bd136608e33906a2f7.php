                    ...
                    <?php if(is_array($allhomework)): foreach($allhomework as $key=>$v): ?><div class="row">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <?php if(($v["htype"] == 2) or ($v["htype"] == 3) ): ?><a href="<?php echo U('Examiner/Homework/detailnew',array('cno' => $_REQUEST['cno'],'cname' => $_REQUEST['cname'],'hno' => $v['hno']));?>" class="title" target="_blank"><?php echo ($v["htitle"]); ?>
                                        </a>
                                    <?php else: ?>                                    
                                        <a href="<?php echo U('Examiner/Homework/detail',array('cno' => $_REQUEST['cno'],'cname' => $_REQUEST['cname'],'hno' => $v['hno']));?>" class="title" target="_blank"><?php echo ($v["htitle"]); ?>
                                        </a><?php endif; ?>
                                    <br/>
