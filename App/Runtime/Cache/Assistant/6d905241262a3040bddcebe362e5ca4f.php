	...
	<div id="main-container" class="container">
		...
		<div class="list-group"  role="menu">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-10">
				<div id="main-right">
					<div class="row">
						<?php if(is_array($group)): foreach($group as $key=>$v): ?><div class="block1 thumbnail ellipsis">
								<a href="<?php echo U('Assistant/Group/groupDetail',array('gno' => $v['gno'],'cno' => $v['cno']));?>" target="_blank"><?php echo ($v["gname"]); ?>
...
<?php  endif ?>
	...
	<div id="info" data-activeitem="#left-group" ></div>
	<footer id="footer">
	<div class="container">
		<div class="col-lg-12">
