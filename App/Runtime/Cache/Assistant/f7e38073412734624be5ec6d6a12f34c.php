				...
				<div id="main-right">
					<div class="panel panel-primary" style="min-width:600px">
						...
						<div class="panel-body">
                            ...
                            <form action="<?php echo U('Assistant/Homeworkgrade/downloadTemplate2');?>" method="POST" class="inline">
								...
								<table class="table table-bordered">
									...
									<?php if(is_array($homeworklist)): foreach($homeworklist as $key=>$v): ?><tr name="<?php echo ($v['sno']); ?>">
										...
										<tr id="scoretr<?php echo ($v['sno']); ?>" style="display:none">
											<td colspan="6">
												<div>
                               						<form action="<?php echo U('Assistant/Homeworkgrade/pointScore');?>" id="point_score_form<?php echo ($v['sno']); ?>"> 
                            ...
                            <div id="scorediv" style="display:none">
                                <form action="<?php echo U('Assistant/Homeworkgrade/pointScore');?>" id="point_score_form"> 
		...
		$(document).ready(function(){
			...
			if(typeof(FileReader)!='undefined'){
               	$("#upload").uploadifive({
               		...
               		fileSizeLimit:'100MB',
               		uploadScript: "<?php echo U('Assistant/Homeworkgrade/uploadGradeList2/');?>",
            ...
            $(".btn-mark").click(function() {
                ...
                var fnolist = [fno];
                var msg = {fno:fno};
                $.post("<?php echo U('Assistant/Homeworkgrade/getPointscore');?>", msg, function(data) {
			...
			$(".point_score_button").click(function(event){
				...
				$.post("<?php echo U('Assistant/Homeworkgrade/pointScore');?>", $("#point_score_form"+sno).serialize(), function(data, textStatus, xhr) {
					if (data.status == 1) {
						alert("评分成功");
