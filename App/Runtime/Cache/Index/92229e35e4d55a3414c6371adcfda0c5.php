    ...
    <div id="content" class="wrap clear">
        <div class="leftCont fl">
            ...
            <div class="productListWrap clear">
                <?php if(is_array($books)): foreach($books as $key=>$b): ?><div class="productItem">
                        <div class="imgBox">
                            <a href="<?php echo U('Index/Index/showDetail',array('bno'=>$b['bno']));?>" >
                        ...
                        <div class="infoCont">
                            <div class="titleRow">
                                <a class="productTitle" title="" href="<?php echo U('Index/Index/showDetail',array('bno'=>$b['bno']));?>"><?php echo ($b["bname"]); ?>
                            ...
                            <div class="saleRow">
                                ...
                                <div class="col end fr">
                                    <span class="weekSale">销量<span class="num"><?php echo ($b["bnum"]); ?></span></span>
                                </div>
                            </div>
                            ...
                            <div class="infoRow seller">
                                <a class="sellerLink"  >共有<?php echo ($b["bzs"]); ?>门店在售</a>
                            </div>
                        </div>
