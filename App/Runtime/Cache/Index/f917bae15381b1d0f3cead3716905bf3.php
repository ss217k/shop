...
<body class="bg">
 ...
 foreach (session('selectedCourses') as $key => $value) { ?>
	...
	<div id="main-container" class="container">
		...
		<div class="row">
			<?php if(is_array($group)): foreach($group as $key=>$v): ?><div class="thumbnail col-lg-2 col-md-2 col-sm-2 col-xs-2 block1 ellipsis" style="line-height: 30px;padding-top: 10px">
					<span class="hide"><?php echo ($v["gno"]); ?></span>
					<p>
						<a href="<?php echo U('Index/Group/home',array('gno' => $v['gno']));?>" title="<?php echo ($v["gname"]); ?>" target="_blank">
						<?php echo ($v["gname"]); ?>
							<br>
							<small>
								<?php echo ($v["gnum"]); ?>人
								<br><?php echo ($v['cname']); ?></small>
						</span>
					</a>
				</p>
