                ...
                <table class="cart_group_item  cart_group_item_product">
                    <thead>
                        <tr>
                            ...
                            <th class="cart_option">用户ID</th>
                        </tr>
                    </thead>
                  
                    <tbody class="hide">
                        <?php if(is_array($tk)): foreach($tk as $key=>$b): ?><tr>
                                <input type="hidden" value="<?php echo ($b['tn']); ?>" id="btn-bno"/>
                            <td valign="top">
                            ...
                            <td>
                                ...
                                <div class="cart_item_num ">
                                    <div class="item_quantity_editer clear" data-item-key="1057066_d150603p892053zc"> 
                                      <!-- <input class="item_quantity" value="<?php echo ($b['cnt']); ?>" type="text" id="btn-cnt"> --> 
                                        <a class="jumei_price" type="text" id="btn-cnt" href="<?php echo U('Index/Index/address',array('umobile'=>$b['umobile'],'ono'=>$b['ono']));?>"><?php echo ($b['umobile']); ?></a> </div>
                                    <div class="item_shortage_tip"> </div>
                                </div>
                            </td>
