			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-10">
				<div id="main-right">
					<div class="panel panel-default">
						<div class="panel-heading" style="background-color:#9b59b6;color:#FFF">课件列表</div>
						<table class="table table-striped">
							<?php if(is_array($filename)): foreach($filename as $key=>$v): ?><tr>
									<td>
										<form action="<?php echo U('Index/Common/documentDownload');?>" method="POST" class="inline">
						...
						<div class="panel-body">老师好像什么都木有传耶~</div>
						<?php endif ?>
					</div>
				</div>
			</div>
...
<?php  endif ?>
	...
	<div id="info" data-activeitem="#left-document" data-activeheader="#header-course"></div>
	<footer id="footer">
	<div class="container">
		<div class="col-lg-12">
