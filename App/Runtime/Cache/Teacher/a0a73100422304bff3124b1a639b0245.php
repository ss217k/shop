                ...
                <div class="row">
                   <div class="panel panel-success" style="border-color:	#008080">
                        ...
                        <div class="panel-body" style="padding:0px;">
                                    ...
                                    <div class="container-fluid"> 
                                        <div> 
                                            <ul class="nav navbar-nav nav-tabs"> 
                                                <li><a href="<?php echo U('Teacher/Backup/index',array('cno' => $_REQUEST['cno']));?>">已备份</a></li> 
                                                ...
                                                <li class="active"><a href="<?php echo U('Teacher/Backup/local',array('cno' => $_REQUEST['cno']));?>">备份本地文件</a></li>
                            ...
                            <a id="dropbt" class="btn btn-primary" style="margin-top:5px;margin-right:10px;margin-bottom:10px;float:right">提交</a>
                        </div>
...
<script>
    $(document).ready(function(){
            $("#dropbt2").click(function(){
            var a = "a";
            var cno = "a";
            $.post("<?php echo U('Teacher/Backup/localBackup');?>",{'cno':cno},function(data){  
                if(data.status==1)
				{
                    alert(' 等备份成功！');
                    CAR(1);
    ...
    Dropzone.options.myAwesomeDropzone = {
        //url:"__ROOT__/App/Lib/ORG/upload.php",
        //url:"__ROOT__/ThinkPHP/Extend/Library/ORG/Dropzone/upload.php",
        //url:"<?php echo U('Teacher/Backup/test');?>",
        //url:"<?php echo U('Teacher/Backup/test',array('cno' => $_REQUEST['cno']));?>",
        url:"<?php echo U('Teacher/home/getdropfile',array('cno' => $_REQUEST['cno']));?>",
        ...
        init:function(){
            ...
            alert("正在备份中(ftp协议至双服务器)...");
            //console.log(file);
            //console.log(res);
            var cno = $("#cnohelp").val();
            $.post("<?php echo U('Teacher/Backup/localBackup');?>",{'cno':cno,'file':res},function(data){
                //console.log(data);
                if(data.status==1)
				{
                    alert(data.name+'备份成功！');
                    CAR(1);
				}
				else
				{
					alert('发布失败 错误编号：'+data.status);console.log(data);
					CA(1);
				}},'json');
            })
        }
