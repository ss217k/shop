	...
	<div id="sidebar2" style="width:110%">
		<div class="panel panel-success">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-10">
                <div id="main-right">
                    <div class="row">
                        <div class="panel  panel-primary panel-my">
                            <div class="panel-heading">
                                <a id="btn-deletecourse" class="accordion-toggle title" href="<?php echo U('Teacher/Homework_point/index',array('cno' => $_REQUEST['cno']));?>">分配指标点</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="panel panel-success" style="border-color:#2C3E50;">
                            ...
                            <div class="panel-body">
                                <?php if(is_array($points)): foreach($points as $key=>$p): ?><div class="col-xs-3 col-md-3">
                                        <div class="panel panel-default">
                                            <a href="<?php echo U('Teacher/Charts/detail',array('cno' => '11111111'));?>">
                                                <div class="panel-body easypiechart-panel">
                                                    <h4><?php echo ($p["pname"]); ?></h4>
                                                    <div class="easypiechart easypiechart-blue" id="easypiechart-blue" data-percent="89">
