					...
					<div class="panel panel-primary">
						...
						<div class="panel-footer" style="padding:0;">
							...
							<form id="form-upload" enctype="multipart/form-data" class="inline">
								...
								-->
<input type="hidden" id="uid_help" name="uid" value="<?php echo ($uid); ?>">
...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
	...
	$(document).ready(function(){
                console.log("<?php echo U('Teacher/Document/uploadDocument/');?>")
		if(typeof(FileReader)!='undefined'){
			$("#upload").uploadifive({
		   		...
		   		fileSizeLimit:'100MB',
				uploadScript: "http://202.112.113.119/OBELearn/teacher/upload/uploadDocument.html",
		   		//uploadScript: "<?php echo U('Teacher/Document/uploadDocument/');?>",
		   		formData:{cno:$("#upload").attr("data-cno"),uid:$("#uid_help").val()},
		...
		$("#btn-upload").click(function(event) {
			...
			$("#form-upload").ajaxSubmit({
            	url:"http://202.112.113.119/OBELearn/teacher/upload/uploadDocument.html",
