			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" id="main-left">
                <div class="panel panel-success" style="border-color:	#1f2c39;">
                    ...
                    <div class="panel-body" style="overflow:auto; ">
                        <input type="hidden" value="<?php echo ($_REQUEST['hno']); ?>" id="tnohelp">
                        <ul class="nav nav-pills nav-stacked" id="exers">
                            <?php if(is_array($homeworks)): foreach($homeworks as $key=>$p): ?><a href="<?php echo U('Teacher/HomeworkPoint/index',array('hno' => $p['hno'],'cno' => $_REQUEST['cno']));?>" class="list-group-item courseitem" id="par<?php echo ($p['hno']); ?>"><?php echo ($p['htitle']); ?></a><?php endforeach; endif; ?>
                            <?php if ($homeworks[0]==null): ?>
                            ...
                            <div style="overflow: auto; height: 400px;width:100%">
                                <table class="tables" >
                                    ...
                                    <?php if(is_array($allcourse)): foreach($allcourse as $key=>$ac): ?><tr>
                                            <td>
                                                <input type="hidden" name="geta" value="test">
